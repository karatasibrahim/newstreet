...
class RegisteredAddresses extends StatefulWidget {
  ...
  const RegisteredAddresses({Key key, this.searchLocationKey})
      : super(key: key);
...
class _RegisteredAddressesState extends State<RegisteredAddresses> {
  ...
  void initState() {
    super.initState();
    labelList = [
          LocaleKeys.addresses_homeLabel,
          LocaleKeys.addresses_workLabel
        ] +
    ...
    switch (index) {
      case 0:
        if (DummyData.user_1.homeAddress == null) {
          ...
          widget.searchLocationKey.currentState.controller.text =
              DummyData.user_1.homeAddress.name;
          widget.searchLocationKey.currentState.location =
              DummyData.user_1.homeAddress;
        }
        break;
      case 1:
        if (DummyData.user_1.workAddress == null) {
          ...
          widget.searchLocationKey.currentState.location =
              DummyData.user_1.workAddress;
        }
        break;
      default:
        widget.searchLocationKey.currentState.controller.text =
            DummyData.user_1.anotherAddresses.values.toList()[index - 2].name;
        widget.searchLocationKey.currentState.location =
            DummyData.user_1.anotherAddresses.values.toList()[index - 2];
        break;
    }
  }
