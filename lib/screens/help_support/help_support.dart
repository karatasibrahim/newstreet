...
class _HelpSupportState extends BaseState<HelpSupport> {
  ...
  Widget body() {
    return Column(
      ...
      children: [
        _getTextSection(LocaleKeys.helpSupport_about_title,
            LocaleKeys.helpSupport_about_body, 15),
        _getTextSection(LocaleKeys.helpSupport_passenger_title,
            LocaleKeys.helpSupport_passenger_body, 15),
        _getTextSection(
            LocaleKeys.helpSupport_taxiAppInfo_title,
            LocaleKeys.helpSupport_taxiAppInfo_body.locale.split(".")[0] + ".",
            10),
        _getTextSection(LocaleKeys.helpSupport_termsAndConditions_title,
            LocaleKeys.helpSupport_termsAndConditions_body, 5),
        Expanded(
          flex: 3,
          child: Container(),
        ),
