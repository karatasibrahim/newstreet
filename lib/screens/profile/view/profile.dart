...
import 'package:newstreet_app/screens/profile/view/personal_information/personal_info_details.dart';
import 'package:newstreet_app/widgets/general/dotted_line.dart';
    ...
    return SingleChildScrollView(
      child: Column(
        ...
        children: [
          ...
          PersonalInfoDetails(),
          DottedLine(context.dynamicWidth(16), context.dynamicWidth(16), 0,
              context.dynamicWidth(10)),
          AddressesInformation(),
          DottedLine(context.dynamicWidth(16), context.dynamicWidth(16), 0,
              context.dynamicWidth(10)),
          AppSettings(),
          DottedLine(context.dynamicWidth(16), context.dynamicWidth(16),
              context.dynamicWidth(10), 0),
          Padding(
