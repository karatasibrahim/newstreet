...
class TripInformation extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Consumer<GoogleMapProvider>(builder: (context, mapModel, child) {
      ...
      return Row(
        ...
        children: [
          _getEqualContainers(context, ImageConstants.ROUTE_ICON_2,
              mapModel.tripDirectionModel.distanceText, 40),
          _getEqualContainers(context, ImageConstants.TIME_ICON,
              mapModel.tripDirectionModel.durationText, 30),
          _getEqualContainers(context, ImageConstants.COIN_ICON,
              price.toStringAsFixed(2) + " TL", 30)
        ],
      );
    });
  }
  ...
  _getEqualContainers(
      BuildContext context, String image, String text, double width) {
